    ...
    <div className="max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <div className="col-span-full lg:col-span-1">
          <a className="flex-none text-2xl font-bold text-gray-900  dark:text-gray-100" href="#" aria-label="Brand">Funiro.</a>
          <p className='py-4 text-[#9F9F9F] dark:text-gray-100'>400 University Drive Suite 200 Coral Gables,
          FL 33134 USA</p>
        </div>
        {/* <!-- End Col --> */}
  
        <div className="col-span-1">
          <h4 className="font-semibold  text-gray-900  dark:text-gray-100">Links</h4>
  
          <div className="mt-3 grid space-y-3">
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Home</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Shop</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">About</a></p>
          <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Contact</a></p>
          </div>
        </div>
        {/* <!-- End Col --> */}
        ...
        <div className="col-span-2">
          <h4 className="font-semibold text-gray-900  dark:text-gray-100">Newsletter</h4>
      ...
      <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
        <div className="flex justify-between items-center">
          <p className="text-sm text-gray-400">2023 furino. All rights reverved</p>
        </div>
        {/* <!-- End Col --> */}
